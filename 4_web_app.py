...
# --- Configuration ---
# Define the path to the converted INT8 model file.
MODEL_PATH = "RPS_Output/RPS_int8.tflite"
...
# Define a function to load the model and labels.
# '@st.cache_resource' is a Streamlit command that tells the app to
# run this function only once and cache the result. This way, the model
# doesn't reload every time the user uploads a new image.
@st.cache_resource
def load_model():
...
# --- Web Page UI ---
# Set the page layout to "wide" to use more of the screen.
st.set_page_config(layout="wide")
# Set the title of the web page (as requested in the prompt).
st.title("Ravikiran's Game Page")
# Write a short description.
st.write("Upload an image of your hand (Rock, Paper, or Scissors) to get a prediction.")

# Create the "Image Upload" button.
# It only accepts 'jpg', 'jpeg', and 'png' files.
...
if uploaded_file is not None and interpreter is not None:
    ...
    # Add a 'batch' dimension (from 224,224,3 to 1,224,224,3) as the model expects a batch of images.
