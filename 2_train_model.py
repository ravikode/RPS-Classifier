...
def download_gcs_dataset(gcs_path, local_path):
    ...
    # This is much faster and more reliable than TensorFlow's GCS integration
    # The 'gcloud' command is already authenticated on Vertex AI
...
def main():
    ...
    # Download the dataset from GCS to the local disk before doing anything
